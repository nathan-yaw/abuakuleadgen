"""
Django settings for lead_gen_api project.
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': False,  # Set based on your needs
...
ROOT_URLCONF = 'lead_gen_api.urls'
...
WSGI_APPLICATION = 'lead_gen_api.wsgi.application'
